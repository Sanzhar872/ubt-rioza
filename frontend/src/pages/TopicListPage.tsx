...
const ERA_LABELS: Record<string, string> = {
  ...
  "МОҢҒОЛ ШАПҚЫНШЫЛЫҒЫ (1-бөлім)": "Моңғол дәуірі",
  "ПУГАЧЕВ КӨТЕРІЛІСІ": "Көтерілістер",
};

const HIGHLIGHTED_TITLES = new Set([
  "МОҢҒОЛ ШАПҚЫНШЫЛЫҒЫ (1-бөлім)",
  "МОҢҒОЛ ШАПҚЫНШЫЛЫҒЫ (2-бөлім)",
  "АЛТЫН ОРДА",
  ...
  "БӨКЕЙ ОРДА КӨТЕРІЛІСІ",
  "БӨКЕЙ ОРДА КӨТЕРІЛІСІ (EASYTARIH)",
...
const BLUE_HIGHLIGHTED_TITLES = new Set([
  ...
  "КІШІ ЖҮЗДІҢ РЕСЕЙГЕ ҚОСЫЛУЫ (JUZ40)",
  "АБЫЛАЙ ХАН",
]);
